...
#define NEON_MAZE_SAVE_VERSION 2U
...
{
    neon_maze_campaign_t *campaign = new_data;
...
static esp_err_t ensure_ready(void)
{
    ...
    mosaico_save_config_t config = {
        ...
        .payload_size = sizeof(neon_maze_campaign_t),
        .debounce_ms = 750,
        .migrate = migrate_v1,
    };
                                 ...
                                 neon_maze_campaign_t *campaign)
{
    ...
    campaign->grades[game->layout < NEON_MAZE_LAYOUTS ? game->layout : 0] =
        (uint8_t)neon_maze_grade(game);
}
                              ...
                              const neon_maze_campaign_t *campaign)
{
    ...
    game->layout = campaign->layout < NEON_MAZE_LAYOUTS ? campaign->layout : 0;
