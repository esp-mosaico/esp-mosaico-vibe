...
先运行[PC 仿真](../tools/gsp-sim/README.md)再验证设备。游戏参考
[Raylib Lite Engine](../submodule/raylib-lite-engine/README.md)，入口见
[游戏开发](game-development.zh-CN.md)；`project init` 不会选择游戏模板。
